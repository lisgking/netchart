...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Canvas__ = __webpack_require__(31);
...
var canvas = new __WEBPACK_IMPORTED_MODULE_0__Canvas__["Canvas"]();
...
var p = new Promise((resolve, reject) => {
    var ajax = __WEBPACK_IMPORTED_MODULE_1_jquery___default.a.ajax({
        type: "POST",
...
function setRelation(nodes,edges){
    ...
    ajax.done(function(msg){
        ...
        Object.keys(node_typs).forEach(function(key){
            ...
            var v_nodes = __WEBPACK_IMPORTED_MODULE_2__util__["default"].getVirtualTypeList(nodes,obj.id);
            console.log(edges);
            
            v_nodes.forEach(function(n){
                new_edge = new_edge.concat(__WEBPACK_IMPORTED_MODULE_2__util__["default"].formatEdgeData(edges,v_nodes,nodes,key));
            });
        });
...
"use strict";
throw new Error("Module build failed: Error: ENOENT: no such file or directory, open 'D:\\git\\netchart\\src\\Canvas.js'");
